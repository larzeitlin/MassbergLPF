...
def main():
  ...
  plistpath = scriptpath + "/resources/LPF-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LPF-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LPF-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LPF-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LPF-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LPF-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/LPF-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/LPF.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/LPF.iss",inplace=1):
